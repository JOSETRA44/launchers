...
private val COMMANDS = listOf(
    ...
    CmdEntry("/bar <s|m|l|bg on|off>", R.string.help_bar),
    CmdEntry("/font <90..125>",        R.string.help_font),
    CmdEntry("/clock <12|24>",         R.string.help_clock),
    CmdEntry("/date <on|off>",         R.string.help_date),
    CmdEntry("/cursor <blink|static>", R.string.help_cursor),
    CmdEntry("/type <instant..slow>",  R.string.help_type),
